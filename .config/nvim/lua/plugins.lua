...
local plugins = {
		...
		config = function()
			require("neogit").setup {
				...
				-- Leave unset when telescope isn't installed
	...
	-- GIT --
	{
		...
		cmd = { "Git", "G", "Gdiffsplit", "Gread", "Gwrite", "Ggrep", "Gclog", "Gblame" },
	},
	...
	},
  {
	...
	{ 'LnL7/vim-nix', ft = "nix" },                         -- nix language support
	{ 'psf/black', ft = "python" },                         -- python formatter
  ...
  'nvim-lua/plenary.nvim',    -- library with async jobs
	...
	-- EDIT -- 
	{ 'tpope/vim-commentary', event = "VeryLazy" },     -- comment and uncomment things
	{ 'tpope/vim-surround', event = "VeryLazy" },       -- parentheses plugin
	{ 'tpope/vim-abolish', event = "VeryLazy" },        -- cool replace
	{ 'tpope/vim-unimpaired', event = "VeryLazy" },
	{ 'tenxsoydev/tabs-vs-spaces.nvim', event = "BufReadPost" }, -- highlight inconsistent usage of tabs and spaces
